...
function Register() {
    ...
    const checkUserNameIsTaken = async (userName)=>{
        await axios.post(process.env.REACT_APP_API_URL_BASE+'/auth/isUserName', {userName})
        .then(res => {
            console.log(res);
        }).catch(err => {
            console.log(err);
    ...
    <div className="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <form onSubmit={handleSubmit} className="my-10">
            <div className="flex flex-col space-y-5 text-left">
                ...
                <p className="text-center">already registered ? <NavLink to="/login" className="text-gray-800 font-medium inline-flex space-x-1 items-center"><span>Login now </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
