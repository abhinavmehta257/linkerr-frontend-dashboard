    ...
    {(provided, snapshot) => (
        ...
        >
            ...
            <div className='item-center flex justify-center flex-col pl-3' {...provided.dragHandleProps}>
                ...
                <div className='grid grid-cols-6 gap-1 p-3 w-[100%]'>
                <div className='col-span-1'>
                            <div  className=" text-center h-full">
                                <div  className='h-full w-full rounded-xl bg-white' style={{background:`url(${link.ImageUrl}) center/cover no-repeat`}} alt='sponser'>
                                    ...
                                    {link.ImageUrl ? '' : (<div onClick={openWidget} disabled={isUploading} className='p-3 text-sm cursor-pointer flex-col flex items-center h-full w-full bg-white rounded-xl'>
                    ...
                    <div className=' col-span-4 grid grid-row-2 gap-1'>
                        <div className="">
